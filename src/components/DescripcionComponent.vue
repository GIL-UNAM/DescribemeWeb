<template>
    <div id="descripcion" class="d-flex flex-column ga-4">
        <p class="text-subtitle-1 text-sm-h6 font-weight-bold">¿Qué es un diccionario inverso?</p>
        ...
        <ol style="width: 85%; align-self: center;">
            ...
            <p class="text-body text-sm-subtitle-1">
                Te muestra una lista de términos que podrían coincidir con lo que quieres decir, ordenados por relevancia.
            </p>
        </ol>
        <p class="text-body text-sm-subtitle-1">
            Es una herramienta ideal si tienes la palabra “en la punta de la lengua”, si estás escribiendo y quieres ser más preciso, o si simplemente te gusta explorar el lenguaje de una forma distinta y creativa.
        </p>
    </div>
</template>
